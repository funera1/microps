...
#define PRIV(x) ((struct loopback *)->priv)
...
// Execute data input processing at the time of interrupt
static int
...
loopback_init(void)
{
    ...
    // alloc device and set parameters
